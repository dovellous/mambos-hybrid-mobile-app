...
// node_modules/framework7/node_modules/dom7/dom7.esm.js
...
function colorHexToRgb(hex) {
  var h4 = hex.replace(/^#?([a-f\d])([a-f\d])([a-f\d])$/i, function(m, r, g, b) {
    return r + r + g + g + b + b;
  });
  var result = /^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(h4);
  return result ? result.slice(1).map(function(n2) {
    return parseInt(n2, 16);
  }) : null;
}
function colorRgbToHex(r, g, b) {
  var result = [r, g, b].map(function(n2) {
    var hex = n2.toString(16);
...
function colorHslToRgb(h4, s, l) {
  var c = (1 - Math.abs(2 * l - 1)) * s;
  var hp = h4 / 60;
  var x = c * (1 - Math.abs(hp % 2 - 1));
  var rgb1;
  if (Number.isNaN(h4) || typeof h4 === "undefined") {
    rgb1 = [0, 0, 0];
  } else if (hp <= 1)
    rgb1 = [c, x, 0];
  else if (hp <= 2)
    ...
    rgb1 = [c, 0, x];
  var m = l - c / 2;
  return rgb1.map(function(n2) {
    return Math.max(0, Math.min(255, Math.round(255 * (n2 + m))));
  });
}
function colorHsbToHsl(h4, s, b) {
  var HSL = {
    h: h4,
    s: 0,
    l: 0
...
function colorHslToHsb(h4, s, l) {
  ...
  var t2 = HSL.s * (HSL.l < 0.5 ? HSL.l : 1 - HSL.l);
  HSB.b = HSL.l + t2;
...
var RequestError = function(_Error) {
  _inheritsLoose2(RequestError2, _Error);
  function RequestError2(obj) {
    var _this;
    _this = _Error.call(this) || this;
    Object.assign(_assertThisInitialized2(_this), obj);
    return _this;
  }
...
var request = function request2(requestOptions) {
  return new Promise(function(resolve, reject) {
    var window2 = getWindow();
    var document2 = getDocument();
    var globalsNoCallbacks = extend2({}, globals);
    ...
    var proceedRequest;
    var options = extend2({}, defaults, requestOptions);
...
var n = function(t2, s, r, e) {
  var u;
  s[0] = 0;
  for (var h4 = 1; h4 < s.length; h4++) {
    var p = s[h4++], a = s[h4] ? (s[0] |= p ? 1 : 2, r[s[h4++]]) : s[++h4];
    p === 3 ? e[0] = a : p === 4 ? e[1] = Object.assign(e[1] || {}, a) : p === 5 ? (e[1] = e[1] || {})[s[++h4]] = a : p === 6 ? e[1][s[++h4]] += a + "" : p ? (u = t2.apply(a, n(t2, a, r, ["", null])), e.push(u), a[0] ? s[0] |= 2 : (s[h4 - 2] = 0, s[h4] = u)) : e.push(a);
  }
  return e;
};
var t = new Map();
function htm_module_default(s) {
  ...
  return r || (r = new Map(), t.set(this, r)), (r = n(this, r.get(s) || (r.set(s, r = function(n2) {
    for (var t2, s2, r2 = 1, e = "", u = "", h4 = [0], p = function(n3) {
      r2 === 1 && (n3 || (e = e.replace(/^\s*\n\s*|\s*\n\s*$/g, ""))) ? h4.push(0, n3, e) : r2 === 3 && (n3 || e) ? (h4.push(3, n3, e), r2 = 2) : r2 === 2 && e === "..." && n3 ? h4.push(4, n3, 0) : r2 === 2 && e && !n3 ? h4.push(5, 0, true, e) : r2 >= 5 && ((e || !n3 && r2 === 5) && (h4.push(r2, 0, e, s2), r2 = 6), n3 && (h4.push(r2, n3, 0, s2), r2 = 6)), e = "";
    }, a = 0; a < n2.length; a++) {
      a && (r2 === 1 && p(), p(a));
      for (var l = 0; l < n2[a].length; l++)
        t2 = n2[a][l], r2 === 1 ? t2 === "<" ? (p(), h4 = [h4], r2 = 3) : e += t2 : r2 === 4 ? e === "--" && t2 === ">" ? (r2 = 1, e = "") : e = t2 + e[0] : u ? t2 === u ? u = "" : e += t2 : t2 === '"' || t2 === "'" ? u = t2 : t2 === ">" ? (p(), r2 = 1) : r2 && (t2 === "=" ? (r2 = 5, s2 = e, e = "") : t2 === "/" && (r2 < 5 || n2[a][l + 1] === ">") ? (p(), r2 === 3 && (h4 = h4[0]), r2 = h4, (h4 = h4[0]).push(2, 0, r2), r2 = 0) : t2 === " " || t2 === "	" || t2 === "\n" || t2 === "\r" ? (p(), r2 = 2) : e += t2), r2 === 3 && e === "!--" && (r2 = 4, h4 = h4[0]);
    }
    return p(), h4;
  }(s)), r), arguments, [])).length > 1 ? r : r[0];
}

// node_modules/framework7/esm/modules/component/$h.js
var ignoreChildren = [false, null, "", void 0];
var h = function h2(type, props) {
  ...
  return {
    type,
    props: props || {},
    children: flattenArray(children2.filter(function(child) {
...
// node_modules/framework7/esm/modules/component/snabbdom/vnode.js
...
// node_modules/framework7/esm/modules/component/snabbdom/is.js
var array = Array.isArray;
function primitive(s) {
  return typeof s === "string" || typeof s === "number";
}

// node_modules/framework7/esm/modules/component/snabbdom/h.js
...
function h3(sel, b, c) {
  ...
  if (array(children2)) {
    for (i = 0; i < children2.length; ++i) {
      if (primitive(children2[i]))
        children2[i] = vnode(void 0, void 0, void 0, children2[i], void 0);
    }
  }
...
// node_modules/framework7/esm/modules/component/custom-components.js
var custom_components_default = {};

// node_modules/framework7/esm/modules/component/vdom.js
...
var getTagName = function getTagName2(treeNode) {
  return typeof treeNode.type === "function" ? treeNode.type.name || "CustomComponent" : treeNode.type;
};
var toCamelCase2 = function toCamelCase3(name) {
  return name.split("-").map(function(word, index2) {
    if (index2 === 0)
      return word.toLowerCase();
    return word[0].toUpperCase() + word.substr(1);
  }).join("");
};
var propsFromAttrs = function propsFromAttrs2() {
  var context = {};
  for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
    args[_key] = arguments[_key];
  }
  args.forEach(function(obj) {
    ...
    Object.keys(obj).forEach(function(key) {
      context[toCamelCase2(key)] = obj[key];
    });
  });
  return context;
};
var createCustomComponent = function createCustomComponent2(_ref) {
  var f7 = _ref.f7, treeNode = _ref.treeNode, vnode2 = _ref.vnode, data2 = _ref.data;
  var component = typeof treeNode.type === "function" ? treeNode.type : custom_components_default[treeNode.type];
  f7.component.create(component, propsFromAttrs(data2.attrs || {}, data2.props || {}), {
    el: vnode2.elm,
    children: treeNode.children
  }).then(function(c) {
    if (vnode2.data && vnode2.data.on && c && c.$el) {
      Object.keys(vnode2.data.on).forEach(function(eventName) {
...
var updateCustomComponent = function updateCustomComponent2(vnode2) {
  var component = vnode2 && vnode2.elm && vnode2.elm.__component__;
  if (!component)
    return;
  var newProps = propsFromAttrs(vnode2.data.attrs || {}, vnode2.data.props || {});
  component.children = vnode2.data.treeNode.children;
  Object.assign(component.props, newProps);
  component.update();
};
var destroyCustomComponent = function destroyCustomComponent2(vnode2) {
  var component = vnode2 && vnode2.elm && vnode2.elm.__component__;
  if (component) {
    var el = component.el, $el = component.$el;
...
var isCustomComponent = function isCustomComponent2(treeNodeType) {
  return typeof treeNodeType === "function" || treeNodeType && treeNodeType.indexOf("-") > 0 && custom_components_default[treeNodeType];
};
function getHooks(treeNode, data2, f7, initial, isRoot) {
  var hooks2 = {};
  var insert3 = [];
  var destroy2 = [];
  var update = [];
  ...
  if (isCustom) {
    ...
    destroy2.push(function(vnode2) {
      destroyCustomComponent(vnode2);
    });
    update.push(function(oldVnode, vnode2) {
      updateCustomComponent(vnode2);
    });
  }
  if (!isCustom) {
    if (!data2 || !data2.attrs || !data2.attrs.class)
      return hooks2;
    var classNames = data2.attrs.class;
    classNames.split(" ").forEach(function(className) {
      if (!initial) {
        insert3.push.apply(insert3, f7.getVnodeHooks("insert", className));
      }
      destroy2.push.apply(destroy2, f7.getVnodeHooks("destroy", className));
      update.push.apply(update, f7.getVnodeHooks("update", className));
      postpatch2.push.apply(postpatch2, f7.getVnodeHooks("postpatch", className));
    });
  }
  if (isRoot && !initial) {
    postpatch2.push(function(oldVnode, vnode2) {
      var vn = vnode2 || oldVnode;
      if (!vn)
        return;
  ...
  if (insert3.length === 0 && destroy2.length === 0 && update.length === 0 && postpatch2.length === 0) {
    return hooks2;
  }
  if (insert3.length) {
    hooks2.insert = function(vnode2) {
      insert3.forEach(function(f) {
        return f(vnode2);
      });
    };
  }
  if (destroy2.length) {
    hooks2.destroy = function(vnode2) {
      destroy2.forEach(function(f) {
        return f(vnode2);
      });
    };
  }
  if (update.length) {
    hooks2.update = function(oldVnode, vnode2) {
      update.forEach(function(f) {
        return f(oldVnode, vnode2);
      });
    };
  }
  if (postpatch2.length) {
    hooks2.postpatch = function(oldVnode, vnode2) {
      postpatch2.forEach(function(f) {
        return f(oldVnode, vnode2);
      });
    };
  }
...
var getEventHandler = function getEventHandler2(eventHandler, _temp) {
  var _ref2 = _temp === void 0 ? {} : _temp, stop2 = _ref2.stop, prevent = _ref2.prevent, once2 = _ref2.once;
  var fired = false;
  function handler() {
...
var getData = function getData2(treeNode, component, f7, initial, isRoot) {
  var data2 = {
    component,
    treeNode
  };
  ...
  var hooks2 = getHooks(treeNode, data2, f7, initial, isRoot);
  hooks2.prepatch = function(oldVnode, vnode2) {
    if (!oldVnode || !vnode2)
      return;
...
var getChildren = function getChildren2(treeNode, component, f7, initial) {
  ...
  for (var i = 0; i < nodes.length; i += 1) {
    ...
    if (Array.isArray(child)) {
      children2.push.apply(children2, child);
    } else if (child) {
...
var getSlots = function getSlots2(treeNode, component, f7, initial) {
...
var isTreeNode = function isTreeNode2(treeNode) {
  return isObject2(treeNode) && "props" in treeNode && "type" in treeNode && "children" in treeNode;
};
var treeNodeToVNode = function treeNodeToVNode2(treeNode, component, f7, initial, isRoot) {
  ...
  var data2 = getData(treeNode, component, f7, initial, isRoot);
  var children2 = isCustomComponent(treeNode.type) ? [] : getChildren(treeNode, component, f7, initial);
  return h_default2(getTagName(treeNode), data2, children2);
};
...
// node_modules/framework7/esm/modules/component/snabbdom/htmldomapi.js
...
function insertBefore2(parentNode2, newNode, referenceNode) {
...
// node_modules/framework7/esm/modules/component/snabbdom/snabbdom.js
function isUndef(s) {
  return s === void 0;
}
function isDef(s) {
...
// node_modules/framework7/esm/modules/component/snabbdom/modules/attributes.js
...
// node_modules/framework7/esm/modules/component/snabbdom/modules/props.js
...
// node_modules/framework7/esm/modules/component/snabbdom/modules/style.js
var raf = typeof window !== "undefined" && window.requestAnimationFrame || setTimeout;
var nextFrame2 = function nextFrame3(fn) {
  raf(function() {
    raf(fn);
  });
};
...
// node_modules/framework7/esm/modules/component/eventslisteners.js
...
function handleEvent(event, args, vnode2) {
  var name = event.type;
  var on2 = vnode2.data.on;
  if (on2 && on2[name]) {
    invokeHandler(on2[name], event, args, vnode2);
  }
}
...
function updateEvents(oldVnode, vnode2) {
  ...
  if (on2) {
    ...
    if (!oldOn) {
      Object.keys(on2).forEach(function(name) {
...
// node_modules/framework7/esm/modules/component/patch.js
var patch = init([attributes_default, props_default, style_default, eventslisteners_default]);
var patch_default = patch;

// node_modules/framework7/esm/modules/component/component-class.js
var Component = function() {
  function Component2(app, component, props, _temp) {
    var _this = this;
    if (props === void 0) {
      props = {};
    }
    var _ref = _temp === void 0 ? {} : _temp, el = _ref.el, context = _ref.context, children2 = _ref.children;
    var document2 = getDocument();
    merge(this, {
      f7: app,
      props: props || {},
    ...
    var createComponent = function createComponent2() {
      return component(_this.props, _this.getComponentContext(true));
    };
    var getRenderFuncion = function getRenderFuncion2(componentResult) {
      return new Promise(function(resolve, reject) {
    ...
    return new Promise(function(resolve, reject) {
      ...
      getRenderFuncion(componentResult).then(function(render) {
        ...
        if (el) {
          ...
          if (_this.style) {
            _this.styleEl = document2.createElement("style");
            _this.styleEl.innerHTML = _this.style;
          }
          _this.el = el;
          patch_default(_this.el, _this.vnode);
          _this.el = _this.vnode.elm;
          _this.$el = dom7_default(_this.el);
          _this.attachEvents();
        ...
        if (tree) {
          _this.vnode = vdom(tree, _this, true);
          _this.el = document2.createElement(_this.vnode.sel || "div");
          patch_default(_this.el, _this.vnode);
          _this.$el = dom7_default(_this.el);
        }
        if (_this.style) {
  ...
  _proto.on = function on2(eventName, handler) {
  ...
  _proto.once = function once2(eventName, handler) {
    if (!this.__eventHandlers)
      return;
  ...
  _proto.getComponentStore = function getComponentStore() {
    var _this2 = this;
    var _this$f7$store = this.f7.store, state = _this$f7$store.state, _gettersPlain = _this$f7$store._gettersPlain, dispatch = _this$f7$store.dispatch;
    var $store = {
      state,
      dispatch
    };
  ...
  _proto.emit = function emit(name, data2) {
    if (!this.el)
      return;
  ...
  _proto.attachEvents = function attachEvents() {
    ...
    this.__eventHandlers.forEach(function(_ref2) {
      var eventName = _ref2.eventName, handler = _ref2.handler;
  ...
  _proto.detachEvents = function detachEvents() {
    ...
    this.__onceEventHandlers.forEach(function(_ref5) {
      var eventName = _ref5.eventName, handler = _ref5.handler;
      $el.once(eventNameToColonCase(eventName), handler);
    });
  };
  _proto.startUpdateQueue = function startUpdateQueue() {
    ...
    var update = function update2() {
      ...
      var tree = _this4.render();
      if (tree) {
        var newVNode = vdom(tree, _this4, false);
        _this4.vnode = patch_default(_this4.vnode, newVNode);
      }
    };
    this.__requestAnimationFrameId = window2.requestAnimationFrame(function() {
      if (_this4.__updateIsPending)
        update();
      var resolvers = [].concat(_this4.__updateQueue);
      _this4.__updateQueue = [];
      _this4.__updateIsPending = false;
      window2.cancelAnimationFrame(_this4.__requestAnimationFrameId);
...
// node_modules/framework7/esm/modules/component/$jsx.js
var ignoreChildren2 = [false, null, "", void 0];
var $jsx = function $jsx2(type, props) {
  for (var _len = arguments.length, children2 = new Array(_len > 2 ? _len - 2 : 0), _key = 2; _key < _len; _key++) {
    children2[_key - 2] = arguments[_key];
  }
  var flatChildren = flattenArray((children2 || []).filter(function(child) {
    return ignoreChildren2.indexOf(child) < 0;
  }));
  if (type === "Fragment") {
    return flatChildren;
  }
...
// node_modules/framework7/esm/modules/component/parse-component.js
function parseComponent(componentString) {
  var window2 = getWindow();
  var document2 = getDocument();
  var componentId = id();
  var callbackCreateName = "f7_component_create_callback_" + componentId;
  var template;
  var hasTemplate = componentString.match(/<template([ ]?)([a-z0-9-]*)>/);
  if (hasTemplate) {
    template = componentString.split(/<template[ ]?[a-z0-9-]*>/).filter(function(item, index2) {
      return index2 > 0;
    }).join("<template>").split("</template>").filter(function(item, index2, arr) {
      return index2 < arr.length - 1;
  ...
  var component = window2[callbackCreateName]();
...
// node_modules/framework7/esm/modules/component/component.js
...
var component_default = {
  ...
  create: function create() {
    ...
    app.component = {
      registerComponent,
      unregisterComponent,
      parse: function parse2(componentString) {
        return parse_component_default(componentString);
      },
      create: function create12(component, props, _ref) {
        var root = _ref.root, el = _ref.el, context = _ref.context, children2 = _ref.children;
...
function createStore(storeParams) {
  ...
  var state = extend2({}, originalState);
  var propsQueue = [];
...
var EventsClass = function() {
  ...
  _proto.on = function on2(events, handler, priority) {
    var self = this;
    if (typeof handler !== "function")
      return self;
  ...
  _proto.once = function once2(events, handler, priority) {
    var self = this;
    if (typeof handler !== "function")
      return self;
    function onceHandler() {
  ...
  _proto.off = function off2(events, handler) {
    var self = this;
...
var Framework7Class = function(_EventsClass) {
  _inheritsLoose3(Framework7Class2, _EventsClass);
  function Framework7Class2(params, parents2) {
    ...
    var self = _assertThisInitialized3(_this);
    self.params = params;
...
function ConstructorMethods(parameters) {
  ...
  var methods = {
    create: function create12() {
      ...
      if (app)
        return _construct3(Constructor, [app].concat(args));
      return _construct3(Constructor, args);
    },
...
function ModalMethods(parameters) {
  ...
  var methods = extend2(ConstructorMethods({
    defaultSelector,
    ...
    if (modulePath) {
      ...
      var scriptLoad = new Promise(function(resolveScript, rejectScript) {
        Framework72.request.get(modulePath, function(scriptContent) {
          ...
          dom7_default("head").append(scriptEl);
          var componentLoader2 = window2[callbackLoadName];
          delete window2[callbackLoadName];
          dom7_default(scriptEl).remove();
          var module2 = componentLoader2(Framework72, false);
          if (!module2) {
...
var Framework7 = function(_Framework7Class) {
  _inheritsLoose4(Framework72, _Framework7Class);
  function Framework72(params) {
    ...
    var support2 = getSupport();
    var passedParams = extend2({}, params);
    var app = _assertThisInitialized4(_this);
    app.device = device;
    ...
    return app || _assertThisInitialized4(_this);
  }
  ...
  _proto.init = function init13(rootEl) {
    var app = this;
    app.mount(rootEl);
    var init14 = function init15() {
      if (app.initialized)
        return;
...
function initTouch() {
  ...
  function handleTouchMove(e) {
    ...
    if (!isScrolling && isSegmentedStrong && segmentedStrongEl) {
      var elementFromPoint = document2.elementFromPoint(e.targetTouches[0].clientX, e.targetTouches[0].clientY);
    ...
    if (isMoved) {
      ...
      if (isTouchMoveActivable) {
        var _elementFromPoint = document2.elementFromPoint(e.targetTouches[0].clientX, e.targetTouches[0].clientY);
...
var History = {
  ...
  initViewState: function initViewState(viewId, viewState) {
    var _extend;
    var window2 = getWindow();
    var newState = extend2({}, History.state || {}, (_extend = {}, _extend[viewId] = viewState, _extend));
  ...
  push: function push(viewId, viewState, url) {
    ...
    History.previousState = History.state;
    var newState = extend2({}, History.previousState || {}, (_extend2 = {}, _extend2[viewId] = viewState, _extend2));
    History.state = newState;
  ...
  replace: function replace(viewId, viewState, url) {
    ...
    History.previousState = History.state;
    var newState = extend2({}, History.previousState || {}, (_extend3 = {}, _extend3[viewId] = viewState, _extend3));
    History.state = newState;
...
function redirect(direction, route, options) {
  ...
  function redirectResolve(redirectUrl2, redirectOptions) {
    ...
    router.allowPageChange = true;
    router[method](redirectUrl2, extend2({}, options, redirectOptions));
  }
...
function modalLoad(modalType, route, loadOptions, direction) {
  ...
  var modalParams = extend2({}, route.route[modalType]);
  var modalRoute = route.route;
  var routeCallback = function routeCallback2(modal, name) {
    var on2 = options.on, once2 = options.once;
    var callback;
    if (name === "open") {
...
var Router = function(_Framework7Class) {
  ...
  function Router2(app, view) {
    ...
    return router || _assertThisInitialized5(_this);
  }
    ...
    routes.forEach(function(route) {
      ...
      if ("detailRoutes" in route) {
        var _mergedPathsRoutes = route.detailRoutes.map(function(detailRoute) {
          var dRoute = extend2({}, detailRoute);
  ...
  _proto.pageCallback = function pageCallback(callback, pageEl, navbarEl, from, to, options, pageFromEl) {
    ...
    var _ref2 = options.route ? options.route.route : {}, _ref2$on = _ref2.on, on2 = _ref2$on === void 0 ? {} : _ref2$on, _ref2$once = _ref2.once, once2 = _ref2$once === void 0 ? {} : _ref2$once;
    if (options.on) {
    ...
    function attachEvents() {
      ...
      if (on2 && Object.keys(on2).length > 0) {
        ...
        Object.keys(on2).forEach(function(eventName) {
      ...
      if (once2 && Object.keys(once2).length > 0) {
        ...
        Object.keys(once2).forEach(function(eventName) {
...
var View = function(_Framework7Class) {
  _inheritsLoose6(View2, _Framework7Class);
  function View2(app, el, viewParams) {
    ...
    var view = _assertThisInitialized6(_this);
    ...
    view.id = viewId;
    if (!view.params.init) {
      return view || _assertThisInitialized6(_this);
    }
    if (app.initialized) {
      view.init();
    } else {
  ...
  _proto.init = function init13(viewEl) {
    var view = this;
    view.mount(viewEl);
...
// node_modules/framework7/esm/modules/router/component-loader.js
var component_loader_default = {
  ...
  proto: {
    ...
    modalComponentLoader: function modalComponentLoader(_temp) {
      var _ref = _temp === void 0 ? {} : _temp, component = _ref.component, componentUrl = _ref.componentUrl, options = _ref.options, resolve = _ref.resolve, reject = _ref.reject;
      var router = this;
    ...
    tabComponentLoader: function tabComponentLoader(_temp2) {
      var _ref2 = _temp2 === void 0 ? {} : _temp2, component = _ref2.component, componentUrl = _ref2.componentUrl, options = _ref2.options, resolve = _ref2.resolve, reject = _ref2.reject;
      var router = this;
      router.componentLoader(component, componentUrl, options, function(el) {
        resolve(el);
      }, reject);
    ...
    pageComponentLoader: function pageComponentLoader(_temp3) {
      var _ref3 = _temp3 === void 0 ? {} : _temp3, component = _ref3.component, componentUrl = _ref3.componentUrl, options = _ref3.options, resolve = _ref3.resolve, reject = _ref3.reject;
      var router = this;
...
var view_default = {
  ...
  create: function create7() {
    ...
    extend2(app, {
      views: extend2([], {
        create: function create12(el, params) {
  ...
  vnode: {
    "view-init": {
      insert: function insert(vnode2) {
        var app = this;
        var viewEl = vnode2.elm;
        if (viewEl.f7View)
          return;
        var viewParams = dom7_default(viewEl).dataset();
        app.views.create(viewEl, viewParams);
      },
      destroy: function destroy(vnode2) {
        var viewEl = vnode2.elm;
        var view = viewEl.f7View;
        if (!view)
          return;
...
var Navbar = {
  ...
  hide: function hide3(el, animate2, hideStatusbar, hideOnlyCurrent) {
    if (animate2 === void 0) {
      animate2 = true;
    }
  ...
  show: function show3(el, animate2, hideOnlyCurrent) {
    if (el === void 0) {
      el = ".navbar-hidden";
    }
    if (animate2 === void 0) {
...
var navbar_default = {
  ...
  vnode: {
    navbar: {
      postpatch: function postpatch(vnode2) {
        var app = this;
...
var toolbar_default = {
  ...
  vnode: {
    tabbar: {
      insert: function insert2(vnode2) {
        var app = this;
...
function _construct4(Parent, args, Class) {
  if (_isNativeReflectConstruct4()) {
    ...
    _construct4 = function _construct5(Parent2, args2, Class2) {
      ...
      var instance = new Constructor();
      if (Class2)
        _setPrototypeOf8(instance, Class2.prototype);
      return instance;
    };
  }
  ...
  create: function create10() {
    ...
    app.touchRipple = {
      create: function create12() {
        ...
        return _construct4(TouchRipple, args);
      }
    };
  }
};
...
var Modal = function(_Framework7Class) {
  _inheritsLoose7(Modal2, _Framework7Class);
  function Modal2(app, params) {
    var _this;
    _this = _Framework7Class.call(this, params, [app]) || this;
    var modal = _assertThisInitialized7(_this);
    var defaults = {};
    ...
    modal.useModules();
    return _assertThisInitialized7(_this) || _assertThisInitialized7(_this);
  }
...
var CustomModal = function(_Modal) {
  _inheritsLoose8(CustomModal2, _Modal);
  function CustomModal2(app, params) {
    var _this;
    var extendedParams = extend2({
      backdrop: true,
      closeByBackdropClick: true,
      on: {}
    }, params);
    _this = _Modal.call(this, app, extendedParams) || this;
    var customModal = _assertThisInitialized8(_this);
    ...
    if ($el && $el.length > 0 && $el[0].f7Modal) {
      return $el[0].f7Modal || _assertThisInitialized8(_this);
    }
    if ($el.length === 0) {
      return customModal.destroy() || _assertThisInitialized8(_this);
    }
    var $backdropEl;
    ...
    return customModal || _assertThisInitialized8(_this);
  }
  return CustomModal2;
}(modal_class_default);
...
var modal_default = {
  ...
  create: function create11() {
    var app = this;
    app.customModal = {
      create: function create12(params) {
...
//# sourceMappingURL=chunk-SJRVKS5Q.js.map
